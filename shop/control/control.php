	...
	private function _getMenuList() {
		$menu_list = array(
			...
			'order' => array('name' => '订单管理', 'child' => array(
				...
				array('name' => '送水工设置', 'act'=>'store_deliver_set', 'op'=>'daddress_list'),
			...
			'store' => array('name' => '我的钱包', 'child' => array(
				array('name' => '我的钱包', 'act'=>'store_wallet', 'op'=>'index'),
				array('name' => '余额结算', 'act'=>'store_bill', 'op'=>'index_oth'),
				array('name' => '水币结算', 'act'=>'store_water', 'op' => 'index'),
			)),
			'promotion' => array('name' => '政策管理', 'child' => array(
				...
				// array('name' => '水币充值', 'act'=>'', 'op'=>'index222'),
			)),
			


			'consult' => array('name' => '物流设置', 'child' => array(
				array('name' => '送水工设置', 'act'=>'store_deliver_set', 'op'=>'daddress_list'),
