	...
	<form name="deliver_form" method="POST" id="deliver_form" action="index.php?act=store_deliver&op=send&order_id=<?php echo $_GET['order_id'];?>" onsubmit="ajaxpost('deliver_form', '', '', 'onerror');return false;">
		...
		<table class="ncsc-default-table order deliver">
			<tbody>
				...
				<tr>
					<td class="bdl w10"></td>
					<td class="w50"><div class="pic-thumb"><a href="#"><img src="<?php echo cthumb($goods_info['goods_image'],'60',$$output['order_info']['store_id']); ?>" /></a></div></td>
					<td class="tl"><dl class="goods-name">
							<dt><a ><?php echo $goods_info['goods_name']; ?></a></dt>
		...
		<div class="step-title mt30"><em><?php echo $lang['store_deliver_second_step'];?></em>选择送货人员信息</div>
		<div class="deliver-sell-info"><strong class="fl"><?php echo $lang['store_deliver_my_daddress'].$lang['nc_colon'];?></strong>
			...
			<?php } else { ?>
				<?php echo $output['daddress_info']['seller_name'];?>&nbsp;<?php echo $output['daddress_info']['telphone'];?>&nbsp;<?php echo $output['daddress_info']['company'];?><!-- &nbsp;<?php echo $output['daddress_info']['address'];?> -->
			<?php } ?>
			</span>
		</div>
