...
<table class="ncsc-default-table order">
	...
	<tbody>
		...
		<tr>
			<td class="bdl"></td>
			<td class="w70"><div class="ncsc-goods-thumb"><a ><img src="<?php echo $goods['image_60_url'];?>" onMouseOver="toolTip('<img src=<?php echo $goods['image_240_url'];?>>')" onMouseOut="toolTip()"/></a></div></td>
			<td class="tl"><dl class="goods-name">
					<dt><a href="#"><?php echo $goods['goods_name']; ?></a><!-- <a target="_blank" class="blue ml5" href="<?php echo urlShop('snapshot', 'index', array('rec_id' => $goods['rec_id']));?>">[交易快照]</a> --></dt>
