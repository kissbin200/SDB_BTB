...
<div class="ncsc-index">
	...
	<div class="seller-cont">
		...
		<div class="container type-a">
			...
			<div class="content">
				<dl class="focus">
					<dd>现有水币：<a href="index.php?act=store_water&op=index"><?php echo $output['store_info']['water_fee'];?></a> 元</dd>
					<br>
					<dd>现有余额：<a href="index.php?act=store_bill&op=index_oth"><?php echo $output['store_info']['money_fee'];?></a> 元</dd>
				</dl>
				<ul>
			...
			<div class="content">
				<table class="ncsc-default-table">
					...
					<tbody>
						<tr class="bd-line">
							<td>昨日销量</td>
							<td><?php echo empty($output['daily_sales'][0]['ordernum']) ? '--' : $output['daily_sales'][0]['ordernum'];?></td>
							<td><?php echo empty($output['daily_sales'][0]['orderamount']) ? '--' : $lang['currency'].$output['daily_sales'][0]['orderamount'];?></td>
						</tr>
						<tr class="bd-line">
							<td>月销量</td>
							<td><?php echo empty($output['monthly_sales'][0]['ordernum']) ? '--' : $output['monthly_sales'][0]['ordernum'];?></td>
							<td><?php echo empty($output['monthly_sales'][0]['orderamount']) ? '--' : $lang['currency'].$output['monthly_sales'][0]['orderamount'];?></td>
						</tr>
					</tbody>
				</table>
			</div>
