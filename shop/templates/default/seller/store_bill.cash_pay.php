<div class="eject_con">
	...
	<form method="post" target="_parent" action="index.php?act=store_bill&op=cash_pay"enctype="multipart/form-data" id="brand_apply_form">
		...
		<dl>
			...
			<dd id="privilege_time_1">
				...
				<p>目前可以提现 <?php echo $output['agree_fee'] ?></p>
			</dd>
		</dl>
		<div class="bottom">
