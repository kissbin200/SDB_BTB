...
<div class="eject_con">
	...
	<form method="post" action="index.php?act=store_deliver_set&op=daddress_add" id="address_form" target="_parent">
		...
		<!-- <dl>
			<dt><i class="required">*</i><?php echo $lang['store_daddress_address'].$lang['nc_colon'];?>出发地址</dt>
			<dd>
		...
		<dl>
			<dt class="required"><i class="required">*</i>车牌号</dt>
			<dd>
				<input type="text" class="text" name="company" value="<?php echo $output['address_info']['company'];?>"/>
			</dd>
		</dl>
		<dl>
			<dt class="required"><i class="required">*</i>登录名</dt>
			<dd>
				<input type="text" class="text" name="login" value="<?php echo $output['address_info']['login'];?>"/>
			</dd>
		</dl>
		<dl>
			<dt class="required"><i class="required">*</i>登录密码</dt>
			<dd>
				<input type="text" class="text" name="pwd" value="<?php echo $output['address_info']['pwd'];?>"/>
			</dd>
		</dl>
		<div class="bottom">
