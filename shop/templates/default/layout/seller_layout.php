...
<header class="ncsc-head-layout w">
	<div class="wrapper">
		<div class="ncsc-admin">
			...
			<div class="ncsc-admin-function"><!-- <a href="<?php echo urlShop('show_store', 'index', array('store_id'=>$_SESSION['store_id']), $output['store_info']['store_domain']);?>" title="前往店铺" ><i class="icon-home"></i></a> --><a href="<?php echo urlShop('store_password_correct', 'index');?>" title="修改密码" target="_blank"><i class="icon-wrench"></i></a><a href="<?php echo urlShop('seller_logout', 'logout');;?>" title="安全退出"><i class="icon-signout"></i></a></div><!-- <?php echo urlMember('member_security', 'auth',array('type'=>'modify_pwd'));?> -->
		</div>		 
...
<div class="ncsc-layout wrapper">
	...
	<div id="layoutRight" class="ncsc-layout-right">
		<div class="ncsc-path"><i class="icon-desktop"></i>供应商管理中心<i class="icon-angle-right"></i><?php echo $output['current_menu']['model_name'];?><i class="icon-angle-right"></i><?php echo $output['current_menu']['name'];?></div>
