...
<div class="public-top-layout w">
  <div class="topbar wrapper">
    ...
    <div class="quick-menu">
      ...
      <dl>
        <dt><a href="<?php echo urlShop('seller_login','show_login');?>" title="商家管理">商家管理</a><i></i></dt>
        <dd>
         <!--  <ul>
		    <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=show_joinin&op=index" title="招商入驻">招商入驻</a></li>
            <li><a href="<?php echo urlShop('show_joinin','index');?>" target="_blank" title="登录商家管理中心">商家登录</a></li>
          </ul> -->
      <?php
