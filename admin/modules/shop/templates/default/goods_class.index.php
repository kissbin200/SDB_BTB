...
<style type="text/css">
.flexigrid .tDiv {background-color: #FAFAFA;border-top: 1px solid #C8C8C8;border-bottom: 1px solid #D7D7D7; position: relative;z-index: 0;overflow: hidden;}
.flexigrid .bDiv {background: #fff;min-height: 300px;position: relative;z-index: 2;    overflow: visible;}
