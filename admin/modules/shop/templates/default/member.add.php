...
<div class="page">
	<div class="fixed-bar">
		<div class="item-title"><a class="back" href="index.php?act=member&op=member" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
			<div class="subject">
				<h3>店东管理 - <?php echo $lang['nc_new']?>会员</h3>
				<h5>平台店东信息设置管理</h5>
			</div>
		</div>
	</div>
	...
	<form id="user_form" enctype="multipart/form-data" method="post">
		...
		<div class="ncap-form-default">
			...
			<dl class="row">
				<dt class="tit">
					<label for="member_passwd">域名</label>
				</dt>
				<dd class="opt">
					<input type="text" value="<?php echo $output['member_array']['user_host'];?>" id="member_user_host" name="member_user_host" class="input-txt" readonly>
					<span class="err"></span>
					<p class="notic"></p>
				</dd>
			</dl>
			<dl class="row">
				<dt class="tit">
					<label for="member_passwd_pay"><em>*</em>支付密码</label>
				</dt>
				<dd class="opt">
					<input type="text" value="" name="member_passwd_pay" id="member_passwd_pay" class="input-txt">
					<span class="err"></span>
					<p class="notic">用户支付时用的密码</p>
				</dd>
			</dl>
			<dl class="row">
				<dt class="tit">
