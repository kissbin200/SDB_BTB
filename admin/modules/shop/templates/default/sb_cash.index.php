	...
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base nc-row">
				<li><a class="current" href="JavaScript:void(0);">水币提现管理</a></li>
			</ul>
		</div>
	</div>
	<!-- 操作说明 -->
...
$(function() {
		var flexUrl = 'index.php?act=sb_cash&op=get_sb_cash_xml';
		...
		$("#flexigrid").flexigrid({
				...
				colModel: [
						...
						{display: '备注', name: 'gettalk', width: 128, sortable: 1, align: 'left'},
				],
				sortname: "id",
				sortorder: "desc",
				title: '水币提现申请列表'
