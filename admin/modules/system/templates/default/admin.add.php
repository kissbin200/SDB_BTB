	...
	<form id="add_form" method="post">
		...
		<div class="ncap-form-default">
			...
			<dl class="row">
				...
				<dd class="opt">
					<input id="admin_nickname" name="admin_nickname" class="input-txt" type="text" value="<?php echo $output['admininfo']['admin_nickname'];?>">
					<span class="err"></span>
					<p class="notic"></p>
				</dd>
			</dl>
			<dl class="row">
				<dt class="tit">
					<label for="member_user_host">域名</label>
				</dt>
				<dd class="opt">
					<input id="member_user_host" name="member_user_host" class="input-txt" type="text" value="<?php echo $output['admininfo']['member_user_host'];?>">
					<span class="err"></span>
					<p class="notic"></p>
				</dd>
			</dl>
