		...
		<table class="flex-table">
			<thead>
				<tr>
					...
					<th width="150" align="center" class="handle">昵称</th>
					<th width="170" align="left"><?php echo $lang['admin_index_username'];?></th>
...
$('.flex-table').flexigrid({	
	...
	title: '管理员列表',
	buttons : [
							 {display: '<i class="fa fa-plus"></i>新增分公司', name : 'add', bclass : 'add', onpress : fg_operation }
					 ]
	});
