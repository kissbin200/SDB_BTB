	...
	*/
	...
	public function addMember($param) {
		...
		try {
			...
			$member_info['user_host'] = $param['user_host'];//绑定域名
			...
			$member_info['btc_id'] = $param['btc_id'];
			$member_info['member_store_address'] = $param['member_store_address'];//绑定域名
	...
	/**
	 * [addWaterPlayer 新增送水员工]
	 * @param [array] $param [员工数据]
	 */
	public function addWaterPlayer($param){
		return $this->table('member_waterplayer')->insert($param);
	}

	/**
	 * [getWaterPlayer 查询送水员工]
	 * @param  [array] $param [查询数组]
	 * @return [array]        [员工信息]
	 */
	public function getWaterPlayer($param){
		return $this->table('member_waterplayer')->where($param)->find();
	}

	/**
	 * [delWaterPlayer 删除送水工信息]
	 * @param  [array] $param [查询数组]
	 * @return [array] [description]
	 */
	public function delWaterPlayer($param){
		return $this->table('member_waterplayer')->where($param)->delete();
	}

	/**
	 * [editWaterPlayer 编辑送水工信息]
	 * @param  [array] $condition [查询条件]
	 * @param  [array] $update    [修改条件]
	 * @return [type]            [description]
	 */
	public function editWaterPlayer($condition,$update){
		return $this->table('member_waterplayer')->where($condition)->update($update);
	}
}
