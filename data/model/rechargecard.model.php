...
class rechargecardModel extends Model
{
	...
	public function getRechargeWaterByID($sn){
		return $this->table('rechargewater')->where(array('activityId' =>$sn))->find();
	}

	public function setRechargeWaterById($id,$data){
		return $this->table('rechargewater')->where(array('activityId' =>$id))->update($data);
	}

	public function delRechargeWaterById($id){
		return $this->table('rechargewater')->where(array('id' => $id ))->delete();
	}
