...
class goodsLogic {
	...
	private function _initCommonGoodsByParam($param, $store_id, $store_name, $store_state) {
		...
		$common_array['goods_distorage']= intval($param['g_distorage']);
		$common_array['goods_price_vip']= $param['goods_price_vip'];
	...
	private function _addGoods($param, $common_id, $common_array) {
		...
		if (is_array($param['spec'])) {
			...
			$goods['goods_distorage']     = intval($param['g_distorage']);
			$goods['goods_price_vip']     = $param['goods_price_vip'];
